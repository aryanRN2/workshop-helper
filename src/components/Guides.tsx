...
import { Rocket, TriangleAlert, Info } from "lucide-react";
    ...
    <div className="glass-panel p-6 flex flex-col">
        ...
        <button
          ...
          className={`pb-3 font-semibold text-sm flex items-center gap-2 border-b-2 transition-all cursor-pointer ${
            activeTab === "walkthrough"
              ? "border-[#00d2ff] text-[#00d2ff] shadow-[0_4px_10px_rgba(0,210,255,0.05)]"
      ...
      {activeTab === "walkthrough" ? (
        <div className="flex flex-col gap-6 animate-fadeIn">
          {/* Warning Alert */}
          <div className="bg-[rgba(245,158,11,0.03)] border border-[rgba(245,158,11,0.15)] rounded-xl p-4 flex gap-3.5 items-start">
            <TriangleAlert className="text-[var(--warning-color)] flex-shrink-0 mt-0.5" size={18} />
            <div className="text-xs">
              <h4 className="font-semibold text-white mb-1">Critical Checkpoint</h4>
          ...
          <div className="flex flex-col gap-5">
            <div className="bg-[rgba(255,255,255,0.01)] border border-[var(--border-color)] rounded-xl p-5 hover:border-[rgba(0,210,255,0.15)] transition-all flex gap-4">
              <div className="w-9 h-9 rounded-full bg-[rgba(0,210,255,0.05)] border border-[rgba(0,210,255,0.15)] text-[#00d2ff] font-bold flex items-center justify-center flex-shrink-0 text-sm">
                1
              </div>
              <div className="text-sm">
                <h3 className="font-bold text-white mb-1.5">Create GCS Bucket</h3>
            ...
            <div className="bg-[rgba(255,255,255,0.01)] border border-[var(--border-color)] rounded-xl p-5 hover:border-[rgba(0,210,255,0.15)] transition-all flex gap-4">
              ...
              <div className="text-sm">
                <h3 className="font-bold text-white mb-1.5">Upload Helper Files</h3>
                <p className="text-[var(--text-muted)] mb-3">
            ...
            <div className="bg-[rgba(255,255,255,0.01)] border border-[var(--border-color)] rounded-xl p-5 hover:border-[rgba(0,210,255,0.15)] transition-all flex gap-4">
              ...
              <div className="text-sm">
                <h3 className="font-bold text-white mb-1.5">Create Cloud Run Function</h3>
            ...
            <div className="bg-[rgba(255,255,255,0.01)] border border-[var(--border-color)] rounded-xl p-5 hover:border-[rgba(0,210,255,0.15)] transition-all flex gap-4">
              ...
              <div className="text-sm">
                <h3 className="font-bold text-white mb-1.5">Deploy Python Code</h3>
                <p className="text-[var(--text-muted)]">
                ...
                <ol className="list-decimal list-inside text-xs text-[var(--text-muted)] mt-2 flex flex-col gap-1.5">
                  <li>Paste generated code in <strong className="text-white">`main.py`</strong></li>
                  <li>Paste package requirements in <strong className="text-white">`requirements.txt`</strong></li>
                  <li>Change <strong>Function entry point</strong> to: <strong className="text-[#00d2ff]">`gcs_inference`</strong></li>
            ...
            <div className="bg-[rgba(255,255,255,0.01)] border border-[var(--border-color)] rounded-xl p-5 hover:border-[rgba(0,210,255,0.15)] transition-all flex gap-4">
              ...
              <div className="text-sm">
                <h3 className="font-bold text-white mb-1.5">Trigger ML Pipeline</h3>
                <p className="text-[var(--text-muted)]">
                  Go to your GCS bucket, click <strong>Upload files</strong>, select <strong>`test.csv`</strong>. Choose <strong className="text-[#10b981]">Overwrite object</strong> if prompted.
                </p>
        ...
        <div className="flex flex-col gap-5 animate-fadeIn">
          ...
          <div className="border border-[rgba(239,68,68,0.15)] bg-[rgba(239,68,68,0.02)] rounded-xl p-5 text-sm">
            ...
            <p className="text-[var(--text-muted)] mb-3">
              The workshop server strictly expects accuracy as a string (e.g. <code>"0.55"</code>), but you sent a number (e.g. <code>0.55</code>).
            </p>
            <div className="bg-black/30 border-l-3 border-[#10b981] p-3.5 rounded-r-lg">
